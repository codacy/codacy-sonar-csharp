...
- [CERT, MSC51-J.](https://wiki.sei.cmu.edu/confluence/x/IDZGBQ) - Do not place a semicolon immediately following an if, for, or while
  condition
- [CERT, EXP15-C.](https://wiki.sei.cmu.edu/confluence/x/WtYxBQ) - Do not place a semicolon on the same line as an if, for, or while
  statement
