    ...
    public class RuleFinder
    {
        ...
        public IEnumerable<Type> GetParameterlessAnalyzerTypes()
        {
            return diagnosticAnalyzers
                ...
                .Where(type => GetTargetLanguages(type).Equals(AnalyzerLanguage.CSharp));
        }
        ...
        public static AnalyzerLanguage GetTargetLanguages(Type analyzerType)
        {
            ...
            if (attribute.Languages.Contains(LanguageNames.CSharp)){
                return AnalyzerLanguage.FromName(LanguageNames.CSharp);
            }
            return null;
            ...
            //     {
            //         language = AnalyzerLanguage.FromName(lang);
            //     }
